...
namespace BeautiesAndBarbers.Controllers.MVC
{
    ...
    public class AccountController : Controller
    {
        ...
        public void UserSession(string modelEmail)
        {
            User user = db.Users.Where(u => u.UserName == modelEmail).FirstOrDefault();
            if (user != null)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    //Create User in BnB
                    User bnbUser = UsersHelper.CreateUser(model.Email, "User");
                    UserSession(model.Email);
                    ...
                    return (bnbUser != null) ? 
                        RedirectToAction("Details", "Users") : 
